warning: unused imports: `I0Timestamp`, `Pin0`, `Pin`
 --> examples/uart.rs:8:27
  |
8 |     use hippomenes_core::{I0Timestamp, Pin, Pin0};
  |                           ^^^^^^^^^^^  ^^^  ^^^^
  |
...
00000094 <uart::app::main::__rtic_init_resources::h216ebd000485b079>:
     ...
     108: 23 0a b5 18  	sb	a1, 404(a0)
     10c: 37 05 00 50  	lui	a0, 327680
     110: 23 2e 05 18  	sw	zero, 412(a0)
     114: 37 05 00 50  	lui	a0, 327680
     118: 23 20 05 1a  	sw	zero, 416(a0)
...
00000284 <core::panicking::panic_fmt::h2fd2ec5d5d8b7281>:
     ...
     290: 13 06 46 09  	addi	a2, a2, 148
...
000002c0 <core::panicking::panic_bounds_check::h21f1f332d5788ef2>:
     ...
     2f4: 13 05 85 0b  	addi	a0, a0, 184
...
00000324 <core::fmt::Formatter::pad_integral::h54f440eb1409ba0b>:
     ...
     370: 63 8e 05 04  	beqz	a1, 0x3cc <.Lline_table_start0+0x11a>
     374: 03 2b c9 01  	lw	s6, 28(s2)
     378: 93 7c 1b 00  	andi	s9, s6, 1
     37c: b7 0a 11 00  	lui	s5, 272
     380: 63 84 0c 00  	beqz	s9, 0x388 <.Lline_table_start0+0xd6>
     384: 93 0a b0 02  	li	s5, 43
     388: b3 8c 8c 00  	add	s9, s9, s0
     38c: 13 75 4b 00  	andi	a0, s6, 4
     390: 63 08 05 04  	beqz	a0, 0x3e0 <.Lline_table_start0+0x12e>
     394: 13 05 00 01  	li	a0, 16
     398: 63 fc a9 04  	bgeu	s3, a0, 0x3f0 <.Lline_table_start0+0x13e>
     39c: 13 05 00 00  	li	a0, 0
     3a0: 63 80 09 06  	beqz	s3, 0x400 <.Lline_table_start0+0x14e>
     ...
     3c4: e3 14 06 fe  	bnez	a2, 0x3ac <.Lline_table_start0+0xfa>
     3c8: 6f 00 80 03  	j	0x400 <.Lline_table_start0+0x14e>
     3cc: 03 2b c9 01  	lw	s6, 28(s2)
     3d0: 93 0c 14 00  	addi	s9, s0, 1
     3d4: 93 0a d0 02  	li	s5, 45
     3d8: 13 75 4b 00  	andi	a0, s6, 4
     3dc: e3 1c 05 fa  	bnez	a0, 0x394 <.Lline_table_start0+0xe2>
     3e0: 13 0a 00 00  	li	s4, 0
     3e4: 03 25 09 00  	lw	a0, 0(s2)
     3e8: 63 12 05 02  	bnez	a0, 0x40c <.Lline_table_start0+0x15a>
     3ec: 6f 00 80 04  	j	0x434 <.Lline_table_start0+0x182>
     ...
     408: 63 06 05 02  	beqz	a0, 0x434 <.Lline_table_start0+0x182>
     40c: 03 2d 49 00  	lw	s10, 4(s2)
     410: 63 f2 ac 03  	bgeu	s9, s10, 0x434 <.Lline_table_start0+0x182>
     414: 13 75 8b 00  	andi	a0, s6, 8
     418: 63 1a 05 0c  	bnez	a0, 0x4ec <.Lline_table_start0+0x68>
     41c: 03 45 09 02  	lbu	a0, 32(s2)
     420: 93 05 10 00  	li	a1, 1
     424: b3 0c 9d 41  	sub	s9, s10, s9
     428: 63 c8 a5 12  	blt	a1, a0, 0x558 <.Lline_table_start0+0xd4>
     42c: 63 12 05 14  	bnez	a0, 0x570 <.Lline_table_start0+0xec>
     430: 6f 00 80 14  	j	0x578 <.Lline_table_start0+0xf4>
     ...
     45c: 63 02 05 04  	beqz	a0, 0x4a0 <.Lline_table_start0+0x1c>
     ...
     52c: e3 1a 05 f2  	bnez	a0, 0x460 <.Lline_table_start0+0x1ae>
     530: b3 09 9d 41  	sub	s3, s10, s9
     534: 93 89 19 00  	addi	s3, s3, 1
     538: 93 89 f9 ff  	addi	s3, s3, -1
     53c: 63 80 09 0e  	beqz	s3, 0x61c <.Lline_table_start0+0x8>
     540: 03 26 0c 01  	lw	a2, 16(s8)
     544: 93 05 00 03  	li	a1, 48
     548: 13 85 0b 00  	mv	a0, s7
     54c: e7 00 06 00  	jalr	a2
     550: e3 04 05 fe  	beqz	a0, 0x538 <.Lline_table_start0+0xb4>
     554: 6f f0 df f0  	j	0x460 <.Lline_table_start0+0x1ae>
     558: 93 05 20 00  	li	a1, 2
     55c: 63 1a b5 00  	bne	a0, a1, 0x570 <.Lline_table_start0+0xec>
     560: 13 d5 1c 00  	srli	a0, s9, 1
     564: 93 8c 1c 00  	addi	s9, s9, 1
     568: 93 dc 1c 00  	srli	s9, s9, 1
     56c: 6f 00 c0 00  	j	0x578 <.Lline_table_start0+0xf4>
     ...
     58c: 63 00 0b 02  	beqz	s6, 0x5ac <.Lline_table_start0+0x128>
     590: 03 26 0c 01  	lw	a2, 16(s8)
     594: 13 85 0b 00  	mv	a0, s7
     598: 93 05 09 00  	mv	a1, s2
     59c: e7 00 06 00  	jalr	a2
     5a0: e3 04 05 fe  	beqz	a0, 0x588 <.Lline_table_start0+0x104>
     5a4: 13 0b 10 00  	li	s6, 1
     5a8: 6f f0 9f eb  	j	0x460 <.Lline_table_start0+0x1ae>
     ...
     5cc: e3 1a 05 e8  	bnez	a0, 0x460 <.Lline_table_start0+0x1ae>
     ...
     5e4: e3 1e 05 e6  	bnez	a0, 0x460 <.Lline_table_start0+0x1ae>
     5e8: b3 04 90 41  	neg	s1, s9
     5ec: 93 09 f0 ff  	li	s3, -1
     5f0: 13 04 f0 ff  	li	s0, -1
     5f4: 33 85 84 00  	add	a0, s1, s0
     5f8: 63 08 35 05  	beq	a0, s3, 0x648 <.Lline_table_start0+0x34>
     ...
     610: e3 02 05 fe  	beqz	a0, 0x5f4 <.Lline_table_start0+0x170>
     614: 33 3b 94 01  	sltu	s6, s0, s9
     618: 6f f0 9f e4  	j	0x460 <.Lline_table_start0+0x1ae>
...
00000654 <core::fmt::Formatter::pad_integral::write_prefix::hd869759600707ead>:
     ...
     680: 63 00 f6 02  	beq	a2, a5, 0x6a0 <.Lline_table_start0+0x8c>
     ...
     69c: 63 9c 05 02  	bnez	a1, 0x6d4 <.Lline_table_start0+0xc0>
     6a0: 63 88 04 02  	beqz	s1, 0x6d0 <.Lline_table_start0+0xbc>
...
000006f0 <core::str::count::do_count_chars::h8ee695d6c36300eb>:
     ...
     72c: 63 ec 85 17  	bltu	a1, s8, 0x8a4 <.Lline_table_start0+0x1a0>
     730: 33 86 85 41  	sub	a2, a1, s8
     734: 13 5a 26 00  	srli	s4, a2, 2
     738: 63 06 0a 16  	beqz	s4, 0x8a4 <.Lline_table_start0+0x1a0>
     73c: 93 75 36 00  	andi	a1, a2, 3
     740: 13 04 00 00  	li	s0, 0
     744: 63 84 a6 02  	beq	a3, a0, 0x76c <.Lline_table_start0+0x68>
     ...
     768: e3 94 06 fe  	bnez	a3, 0x750 <.Lline_table_start0+0x4c>
     76c: 33 0c 85 01  	add	s8, a0, s8
     770: 13 05 00 00  	li	a0, 0
     774: 63 84 05 02  	beqz	a1, 0x79c <.Lline_table_start0+0x98>
     ...
     798: e3 94 05 fe  	bnez	a1, 0x780 <.Lline_table_start0+0x7c>
     ...
     7b8: 6f 00 c0 03  	j	0x7f4 <.Lline_table_start0+0xf0>
     ...
     7f0: 63 9e 0c 0c  	bnez	s9, 0x8cc <.Lline_table_start0+0x1c8>
     7f4: 63 04 0a 14  	beqz	s4, 0x93c <.Lline_table_start0+0x238>
     7f8: 93 0a 0a 00  	mv	s5, s4
     7fc: 13 0b 0c 00  	mv	s6, s8
     800: 13 05 00 0c  	li	a0, 192
     804: 93 0b 0a 00  	mv	s7, s4
     808: 63 64 aa 00  	bltu	s4, a0, 0x810 <.Lline_table_start0+0x10c>
     80c: 93 0b 00 0c  	li	s7, 192
     810: 13 06 00 00  	li	a2, 0
     814: 13 d5 2b 00  	srli	a0, s7, 2
     818: e3 02 05 fa  	beqz	a0, 0x7bc <.Lline_table_start0+0xb8>
     ...
     89c: e3 96 a5 f8  	bne	a1, a0, 0x828 <.Lline_table_start0+0x124>
     8a0: 6f f0 df f1  	j	0x7bc <.Lline_table_start0+0xb8>
     8a4: 13 04 00 00  	li	s0, 0
     8a8: 63 8a 05 08  	beqz	a1, 0x93c <.Lline_table_start0+0x238>
     ...
     8c4: e3 94 05 fe  	bnez	a1, 0x8ac <.Lline_table_start0+0x1a8>
     8c8: 6f 00 40 07  	j	0x93c <.Lline_table_start0+0x238>
     ...
     914: e3 9e 05 fc  	bnez	a1, 0x8f0 <.Lline_table_start0+0x1ec>
...
00000974 <core::fmt::num::imp::fmt_u32::hc69911958cd28b6c>:
     ...
     9c4: 63 76 b5 02  	bgeu	a0, a1, 0x9f0 <.Lline_table_start0+0x2ec>
     9c8: 13 05 30 06  	li	a0, 99
     9cc: 63 62 25 0f  	bltu	a0, s2, 0xab0 <.Lline_table_start0+0x3ac>
     9d0: 13 05 a0 00  	li	a0, 10
     9d4: 63 70 a9 14  	bgeu	s2, a0, 0xb14 <.Lline_table_start0+0x410>
     ...
     9ec: 6f 00 40 15  	j	0xb40 <.Lline_table_start0+0x43c>
     ...
     a08: 13 0c 85 0c  	addi	s8, a0, 200
     ...
     aa0: e3 ea 4c f7  	bltu	s9, s4, 0xa14 <.Lline_table_start0+0x310>
     aa4: 13 8a 7a 02  	addi	s4, s5, 39
     aa8: 13 05 30 06  	li	a0, 99
     aac: e3 72 25 f3  	bgeu	a0, s2, 0x9d0 <.Lline_table_start0+0x2cc>
     ...
     ae8: 93 85 85 0c  	addi	a1, a1, 200
     ...
     b10: e3 e4 a9 ec  	bltu	s3, a0, 0x9d8 <.Lline_table_start0+0x2d4>
     b14: 13 19 19 00  	slli	s2, s2, 1
     b18: 13 0a ea ff  	addi	s4, s4, -2
     b1c: 37 05 00 50  	lui	a0, 327680
     b20: 13 05 85 0c  	addi	a0, a0, 200
     ...
     b54: 13 06 45 09  	addi	a2, a0, 148
...
00000bbc <__mulsi3>:
     ...
     bc0: 63 00 05 02  	beqz	a0, 0xbe0 <.Lline_table_start0+0x4dc>
     ...
     bdc: e3 14 05 fe  	bnez	a0, 0xbc4 <.Lline_table_start0+0x4c0>
...
00000be8 <compiler_builtins::int::specialized_div_rem::u32_div_rem::h07e771e3bc67a4d3>:
     ...
     bec: 63 78 b5 00  	bgeu	a0, a1, 0xbfc <.Lline_table_start0+0x4f8>
     ...
     c0c: 63 64 b7 00  	bltu	a4, a1, 0xc14 <.Lline_table_start0+0x510>
     ...
     c24: 63 e4 b7 00  	bltu	a5, a1, 0xc2c <.Lline_table_start0+0x528>
     ...
     c40: 63 e4 b7 00  	bltu	a5, a1, 0xc48 <.Lline_table_start0+0x544>
     ...
     c5c: 63 e4 b7 00  	bltu	a5, a1, 0xc64 <.Lline_table_start0+0x560>
     ...
     c8c: 63 60 b6 08  	bltu	a2, a1, 0xd0c <.Lline_table_start0+0x608>
     c90: 63 46 07 00  	bltz	a4, 0xc9c <.Lline_table_start0+0x598>
     c94: 93 07 05 00  	mv	a5, a0
     c98: 6f 00 80 03  	j	0xcd0 <.Lline_table_start0+0x5cc>
     ...
     cbc: 63 54 08 00  	bgez	a6, 0xcc4 <.Lline_table_start0+0x5c0>
     cc0: 13 08 06 00  	mv	a6, a2
     cc4: 33 e5 a8 00  	or	a0, a7, a0
     cc8: 13 06 08 00  	mv	a2, a6
     ccc: 63 60 b8 04  	bltu	a6, a1, 0xd0c <.Lline_table_start0+0x608>
     cd0: 93 87 f7 ff  	addi	a5, a5, -1
     cd4: 63 86 06 02  	beqz	a3, 0xd00 <.Lline_table_start0+0x5fc>
     cd8: 93 85 06 00  	mv	a1, a3
     cdc: 6f 00 c0 00  	j	0xce8 <.Lline_table_start0+0x5e4>
     ce0: 93 85 f5 ff  	addi	a1, a1, -1
     ce4: 63 8e 05 00  	beqz	a1, 0xd00 <.Lline_table_start0+0x5fc>
     ce8: 13 16 16 00  	slli	a2, a2, 1
     cec: 33 08 e6 40  	sub	a6, a2, a4
     cf0: 13 08 18 00  	addi	a6, a6, 1
     cf4: e3 46 08 fe  	bltz	a6, 0xce0 <.Lline_table_start0+0x5dc>
     cf8: 13 06 08 00  	mv	a2, a6
     cfc: 6f f0 5f fe  	j	0xce0 <.Lline_table_start0+0x5dc>
